...
class VistaAjustes(QWidget):
    def __init__(self):
        ...
        self.metodo_seleccionado = None # NUEVO
        
        self.setup_ui()
        self.actualizar_todo() 

    def actualizar_todo(self):
        """Recarga todas las tablas al entrar al módulo"""
        self.cargar_monedas()
        self.cargar_listas()
        self.cargar_departamentos()
        self.cargar_metodos() # NUEVO
    ...
    def setup_ui(self):
        ...
        lbl_subtitulo = QLabel("Configura las reglas de negocio, divisas, listas, departamentos y métodos de pago.")
        ...
        self.tab_metodos = QWidget() # 🔥 NUEVA PESTAÑA DE MÉTODOS DE PAGO
        
        self.setup_tab_monedas()
        self.setup_tab_listas()
        self.setup_tab_departamentos()
        self.setup_tab_metodos() # 🔥 CONFIGURARLA
        
        self.tabs.addTab(self.tab_monedas, "💵 Divisas y Tasas")
        self.tabs.addTab(self.tab_listas, "📋 Estructura de Precios")
        self.tabs.addTab(self.tab_deptos, "📂 Departamentos")
        self.tabs.addTab(self.tab_metodos, "💳 Métodos de Pago") # 🔥 AÑADIRLA AL MENÚ
    ...
    def abrir_modal_metodo(self):
        ...
        # Llenamos las monedas disponibles
